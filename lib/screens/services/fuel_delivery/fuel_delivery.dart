              ...
              children: [
                Container(
                  ...
                  child: Row(mainAxisSize: MainAxisSize.min, children: [
                    Image(
                        image: AssetImage('assets/images/fuel_icon_white.png')),
                    SizedBox(width: 20),
                    Text('Fuel Delivery',
                ...
                Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        buildSelectableButton(
                            'OJM', isOJMSelected, () => updateSelection('OJM')),
                        const SizedBox(width: 20),
                        buildSelectableButton('Apec', isApecSelected,
                            () => updateSelection('Apec')),
                      ],
                    ),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        buildSelectableButton('Coral', isCoralSelected,
                            () => updateSelection('Coral')),
                        const SizedBox(width: 20),
                        buildSelectableButton(
                            'IPT', isIPTSelected, () => updateSelection('IPT')),
                      ],
                    ),
                    const SizedBox(height: 20),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        buildSelectableButton('Total', isTotalSelected,
                            () => updateSelection('Total')),
                        const SizedBox(width: 20),
                        buildSelectableButton('Medco', isMedcoSelected,
                            () => updateSelection('Medco')),
                      ],
                    ),
                  ],
                ),
                      ...
                      CustomNextButton(onPressed: () {
                        if (selectedProvider == '' || price == 0) {
                          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                            content: Text(
                              'please select a provider and fuel type',
                              style: TextStyle(
                                color: Colors.white,
                                fontSize: 16,
                              ),
